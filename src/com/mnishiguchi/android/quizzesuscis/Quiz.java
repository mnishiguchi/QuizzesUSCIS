...
{
    // CLASS VARIABLE
    private static ArrayList<Quiz> quizzes = new ArrayList<Quiz>(100);
    private static ArrayList<String> questions = new ArrayList<String>(100);
    private static ArrayList<String> answers = new ArrayList<String>(100);
    ...
    static ArrayList<Quiz> getQuizzes()
    {
        ...
        quizzes.add(new Quiz("1. What is the supreme law of the land?",
                "the Constitution"));
        quizzes.add(new Quiz("2. What does the Constitution do?",
                "sets up the government | defines the government | protects basic rights of Americans"));
        quizzes.add(new Quiz("3. The idea of self-government is in the first three words of the Constitution. What are these words?",
                "We the People"));
        quizzes.add(new Quiz("4. What is an amendment?",
        ...
        quizzes.add(new Quiz("7. How many amendments does the Constitution have?",
                "twenty-seven (27)"));
        ...
        quizzes.add(new Quiz("15. Who is in charge of the executive branch?",
                "the President"));
        ...
        quizzes.add(new Quiz("18. How many U.S. Senators are there?",
                "one hundred (100)"));
        quizzes.add(new Quiz("19. We elect a U.S. Senator for how many years?",
                "six (6)"));
        ...
        quizzes.add(new Quiz("22. We elect a U.S. Representative for how many years?",
                "two (2)"));
        ...
        quizzes.add(new Quiz("26. We elect a President for how many years?",
                "four (4)"));
        quizzes.add(new Quiz("27. In what month do we vote for President?",
                "November"));
        quizzes.add(new Quiz("28. What is the name of the President of the United States now?",
                "Barack Obama"));
        ...
        quizzes.add(new Quiz("32. Who is the Commander in Chief of the military?",
                "the President"));
        quizzes.add(new Quiz("33. Who signs bills to become laws?",
                "the President"));
        quizzes.add(new Quiz("34. Who vetoes bills?",
                "the President"));
        quizzes.add(new Quiz("35. What does the PresidentÅfs Cabinet do?",
        ...
        quizzes.add(new Quiz("38. What is the highest court in the United States?",
                "the Supreme Court"));
        quizzes.add(new Quiz("39. How many justices are on the Supreme Court?",
                "nine (9)"));
        quizzes.add(new Quiz("40. Who is the Chief Justice of the United States now?",
                "John Roberts (John G. Roberts, Jr.)"));
        quizzes.add(new Quiz("41. Under our Constitution, some powers belong to the federal government. What is one power of the federal government?",
                "to print money | to declare war | to create an army | to make treaties"));
        quizzes.add(new Quiz("42. Under our Constitution, some powers belong to the states. What is one power of the states? ",
        ...
        quizzes.add(new Quiz("66. When was the Constitution written?",
                "1787"));
        ...
        quizzes.add(new Quiz("69. Who is the ÅgFather of Our CountryÅh?",
                "(George) Washington"));
        quizzes.add(new Quiz("70. Who was the first President?",
                "(George) Washington"));
        ...
        quizzes.add(new Quiz("99. When do we celebrate Independence Day?",
                "July 4"));
